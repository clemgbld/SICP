        ...
        ((compound-procedure? procedure)
         (eval-sequence
          ...
          (extend-environment
           ...
           (list-of-delayed-args arguments procedure env)
...
(define (list-of-delayed-args exps procedure env)
      (let ((params (cadr procedure)))
            (define (recur exps params env)
            (if (no-operands? exps) '()
                  ...
                  (actual-value (first-operand exps)
                          env)) 
            (recur (rest-operands exps) (cdr params) env))))
   (recur exps params env)))
