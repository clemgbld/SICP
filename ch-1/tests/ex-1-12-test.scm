...
(assert-false (pascal 0 2) "should be false when the column is less than one")
...
(check (= 3 (pascal 3 4)) "should be 3 for the 3th column of the 4th row")
(check (= 15 (pascal 3 7)) "should be 15 for the 3th column of the 7th row")
)
