...
((assign proc (op lookup-variable-value) (const +) (reg env)) 
(assign val (const 3)) 
(assign argl (op list) (reg val)) (assign val (const 2)) 
(assign argl (op cons) (reg val) (reg argl)) 
(assign val (const 1)) 
(assign argl (op cons) (reg val) (reg argl)) 
(test (op primitive-procedure?) (reg proc)) 
(branch (label primitive-branch3)) 
compiled-branch2 (assign continue (label after-call1)) 
(assign val (op compiled-procedure-entry) (reg proc)) (goto (reg val)) 
primitive-branch3 
(assign val (op apply-primitive-procedure) (reg proc) (reg argl)) after-call1))

;the difference is quite striking the optimized version is about 3 times smaller and has no save and restore operation
;whereas the non optimized version has 13 save and restore useless operations.
